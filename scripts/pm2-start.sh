...
# 用法：
#   ./scripts/pm2-start.sh              # 启动全部（gateway + usercenter x3 + order + docs + upload）
#   ./scripts/pm2-start.sh gateway      # 只启动网关
#   ./scripts/pm2-start.sh apps         # 只启动 usercenter + order + docs + upload
